  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="eAvicultureApp.produit.home.createOrEditLabel">Create or edit a Produit</h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : produitEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="prixUnitaireLabel" for="produit-prixUnitaire">
                  Prix Unitaire
                </Label>
                <AvField id="produit-prixUnitaire" type="text" name="prixUnitaire" />
              </AvGroup>
              <AvGroup>
