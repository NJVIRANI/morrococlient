    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>{produitEntity.codeProduit}</dd>
          <dt>
          ...
          <dd>{produitEntity.prixUnitaire}</dd>
          <dt>Type</dt>
          <dd>{produitEntity.type ? produitEntity.type.id : ''}</dd>
          <dt>Emplacement</dt>
          <dd>{produitEntity.emplacement ? produitEntity.emplacement.id : ''}</dd>
        </dl>
